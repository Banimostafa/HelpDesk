...
<div class="btm" id="newMessage" onclick="window.location='?page=add_system'">
سیستم جدید
</div>

<div class="btm" id="delBtm" onclick="delsys()" style="display:none;">
حذف
</div>

<div class="btm" id="viewBtm" onclick="setAction('add_system')" style="display:none;">
ویرایش
</div>
...
<span style="width:400px;">نام سیستم </span>
</div>
