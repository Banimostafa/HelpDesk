...
<div class="btm" id="newMessage" onclick="window.location='?page=add_storage'">
کالای جدید
</div>

<div class="btm" id="delBtm" onclick="delstore()" style="display:none;">
حذف
</div>

<div class="btm" id="viewBtm" onclick="setAction('add_storage')" style="display:none;">
ویرایش
</div>
...
<span style="width:100px;">عنوان </span>
<span style="width:300px;">شرح </span>
</div>
...
<select id="section" class="textbox">
		...
		<option value="useable">خراب: قابل تعمیر</option>
		<option value="outofuse">خراب : اسقاطی</option>
</select>
</div>
<script>
loadstore('0');
