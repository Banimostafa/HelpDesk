...
<div class="btm" id="newMessage" onclick="window.location='?page=add_pishgirane'">
فعالیت جدید
</div>

<div class="btm" id="delBtm" onclick="delpishgirane()" style="display:none;">
حذف
</div>

<div class="btm" id="viewBtm" onclick="setAction('add_pishgirane')" style="display:none;">
ویرایش
</div>
...
<span style="width:400px;">عنوان فعالیت </span>
</div>
